...
public:
  JsonNode();
  JsonNode(JsonValueType _value_type, const std::string &_key = "");
...
public:
  void toJsonStr(std::string &_dst_str, bool _print_key = true,
                 int _tab_num = 0, bool _one_line_per_element = false) const;
